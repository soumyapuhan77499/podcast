	...
	<header class="header">
		<div class="header__content">
			...
			<nav class="header__nav">
				<a href="profile.html">Shop</a>
				<a href="about.html">Book Pandit</a>
    ...
    <div class="store-item">
        ...
        <div class="store-item__description">
           ...
           <div class="share_banner">
		     <span class="whatsapp"><ion-icon name="logo-whatsapp"></ion-icon></span>
			 <span class="facebook"><ion-icon name="logo-facebook"></ion-icon></span>
